...
export const autoRedirectOrchestrator2 = async (
  ...
  console.log("!!!_Executing autoRedirectOrchestrator2...!!!", props.autoProps?.currentMessage);
  let result = {
    nextAgent: "",
...
export const autoRedirectOrchestrator3 = async (
  props: OrchestrationProps
): Promise<{
  nextAgent: string;
  contextRequest: boolean;
  ...
  console.log("!!!_Executing autoRedirectOrchestrator3...!!!", props.autoProps?.currentMessage);
  let result = {
    nextAgent: "",
    contextRequest: false,
    redirectToUser: false,
